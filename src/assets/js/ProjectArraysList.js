...
export const projectsList = reactive([
  {
    ...
    data: [
      ...
      },
      {
        id: 2,
        title: "Portfolio",
        description: "Création d'un portfolio avec VueJS, Tailwind CSS, SASS",
        content: "",
        dateCreatedText: "Créé en",
        dateCreated: "10/17/2024",
        dateUpdatedText: "Mis à jour en",
        dateUpdated: "02/28/2025",
        images: [],
        images_folder: "Portfolio",
        tagstitle: "Liste des languages utilisés pour réaliser ce projet",
        tags: [1, 2, 3, 9, 11, 16],
        url: [
          {
            id: 1,
            url: "https://www.github.com/AeRogue666/Portfolio",
            icon: "github",
          },
        ],
        mdlink: "Portfolio.md",
      ...
      {
        id: 3,
        title: "Aggregateur météo",
        description:
          "Création d'une application d'aggregations météo avec VueJS, Tailwind CSS, SASS et Vue-I18n",
        content: "",
        dateCreatedText: "Créé en",
        dateCreated: "03/04/2025",
        dateUpdatedText: "Mis à jour en",
        dateUpdated: "03/18/2025",
        images: [9, 10, 11],
        images_folder: "WeatherApp",
        tagstitle: "Liste des languages utilisés pour réaliser ce projet",
        tags: [1, 2, 3, 9, 11, 16],
        url: [
          {
            id: 1,
            url: "https://www.github.com/AeRogue666/WeatherApp",
            icon: "github",
          },
        ],
        mdlink: "WeatherApp.md",
      },
      {
        id: 4,
        title: "Calculatrice",
        description: "Création d'une calculatrice avec HTML, CSS et JavaScript",
        content: "",
        dateCreatedText: "Créé en",
        dateCreated: "03/18/2025",
        dateUpdatedText: "Mis à jour en",
        dateUpdated: "03/19/2025",
        images: [8, 21],
        images_folder: "Calculator",
        tagstitle: "Liste des languages utilisés pour réaliser ce projet",
        tags: [1, 2, 3],
        url: [
          {
            id: 1,
            url: "https://www.github.com/AeRogue666/Calculator",
            icon: "github",
          },
        ],
        mdlink: "Calculator.md",
      },
      {
        id: 5,
        title: "Convertisseur d'unités de distance",
        description:
          "Création d'un convertisseur d'unités de distance (mètres en yards, etc.) en HTML, CSS & JavaScript",
        content: "",
        dateCreatedText: "Créé en",
        dateCreated: "03/18/2025",
        dateUpdatedText: "Mis à jour en",
        dateUpdated: "03/19/2025",
        images: [12, 13, 14],
        images_folder: "Unit_Converter",
        tagstitle: "Liste des languages utilisés pour réaliser ce projet",
        tags: [1, 2, 3],
        url: [
          {
            id: 1,
            url: "https://www.github.com/AeRogue666/Unit_Converter",
            icon: "github",
          },
        ],
        mdlink: "Unit_Converter.md",
      },
      {
        id: 6,
        title: "Minuteur de tâches",
        description:
          "Création d'une application de minuterie (type Pomodoro timer) intégrant un système de tâches avec VueJS, Tailwind CSS et Vue-I18n",
        content: "",
        dateCreatedText: "Créé en",
        dateCreated: "03/19/2025",
        dateUpdatedText: "Mis à jour en",
        dateUpdated: "04/18/2025",
        images: [15, 16, 17, 18, 19, 20],
        images_folder: "TasksTimer",
        tagstitle: "Liste des languages utilisés pour réaliser ce projet",
        tags: [1, 2, 3, 9, 11, 16],
        url: [
          {
            id: 1,
            url: "https://www.github.com/AeRogue666/TasksTimer",
            icon: "github",
          },
        ],
        mdlink: "TasksTimer.md",
      },
    ],
  },
  {
    ...
    data: [
      ...
      },
      {
        id: 2,
        title: "Portfolio",
        description: "Creation of a portfolio with VueJS, Tailwind CSS, SASS",
        content: "",
        dateCreatedText: "Created at",
        dateCreated: "10/17/2024",
        dateUpdatedText: "Updated at",
        dateUpdated: "05/28/2025",
        images: [],
        images_folder: "Portfolio",
        tagstitle: "Languages list used for this project",
        tags: [1, 2, 3, 9, 11, 16],
      ...
      },
      {
        ...
        description:
          "Creation of an Aggregator App for weather with VueJS, Tailwind CSS, SASS & Vue-I18n",
        content: "",
        dateCreatedText: "Created at",
        dateCreated: "03/04/2025",
        dateUpdatedText: "Updated at",
      ...
      },
      {
        id: 4,
        title: "Calculator",
        description: "Creation of a calculator with HTML, CSS & JavaScript",
        content: "",
        dateCreatedText: "Created at",
        dateCreated: "03/18/2025",
        dateUpdatedText: "Updated at",
      ...
      },
      {
        ...
        description:
          "Creation of a unit converter (meters to yards) with HTML, CSS & JavaScript",
        content: "",
        dateCreatedText: "Created at",
        dateCreated: "03/18/2025",
        dateUpdatedText: "Updated at",
      ...
      },
      {
        ...
        title: "Tasks timer",
        description:
          "Creation of a timer (Pomodoro timer type) with an integrated tasks system with VueJS, Tailwind CSS & Vue-I18n",
        content: "",
        dateCreatedText: "Created at",
        dateCreated: "03/19/2025",
        dateUpdatedText: "Updated at",
...
export const imagesList = [
  {
    ...
    data: [
      ...
      },
      {
        ...
        title: "Image créé par AurelDev",
        url: "Default",
        description: "Image d'une calculatrice",
      },
      {
        id: 9,
        title: "Image créé par AurelDev",
        url: "Weather_details",
        description:
          "Image de la météo du jour et météo de la semaine émis par une API",
      },
      {
        id: 10,
        title: "Image créé par AurelDev",
        url: "Default",
        description:
          "Image de la page d'accueil de l'application d'aggrégration météo",
      },
      {
        id: 11,
        title: "Image créé par AurelDev",
        url: "Weathers_list",
        description: "Image de la liste des résultats météo après recherche",
      },
      {
        id: 12,
        title: "Image créé par AurelDev",
        url: "Default",
        description: "Image du convertisseur d'unités",
      },
      {
        id: 13,
        title: "Image créé par AurelDev",
        url: "Convert_meter_yards",
        description:
          "Image affichant la conversion d'une valeur en mètre vers une valeur en yard",
      },
      {
        id: 14,
        title: "Image créé par AurelDev",
        url: "Convert_yards_meter",
        description:
          "Image affichant la conversion d'une valeur en yard vers une valeur en mètre",
      },
      {
        id: 15,
        title: "Image créé par AurelDev",
        url: "Default",
        description: "Image de la page d'accueil du minuteur de tâches",
      },
      {
        id: 16,
        title: "Image créé par AurelDev",
        url: "Add_task_menu",
        description: "Image du menu pour créer une tâche",
      },
      {
        id: 17,
        title: "Image créé par AurelDev",
        url: "Edit_task_menu",
        description:
          "Image du menu pour modifier le titre et le status d'une tâche ainsi que la possibilité de la supprimer",
      },
      {
        id: 18,
        title: "Image créé par AurelDev",
        url: "Timer_settings",
        description:
          "Image du menu pour paramétrer le minuteur en réglant le temps de travail et de pauses ainsi que le nombre et le type de cycles de travail",
      },
      {
        id: 19,
        title: "Image créé par AurelDev",
        url: "Tasks_list_section",
        description: "Image de la liste des tâches en cours",
      },
      {
        id: 20,
        title: "Image créé par AurelDev",
        url: "Tasks_list_completed_section",
        description: "Image de la liste des tâches réalisées",
      },
      {
        id: 21,
        title: "Image créé par AurelDev",
        url: "Calculator_1",
        description: "Image d'une calculatrice avec un calcul",
      },
    ],
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        title: "Image created by AurelDev",
        url: "Calculator_1",
        description: "Image of a calculator",
      },
      {
        id: 9,
        title: "Image created by AurelDev",
        url: "Weather_details",
        description: "Image of daily and weekly meteo from an API",
      },
      {
        id: 10,
        title: "Image created by AurelDev",
        url: "Default",
        description: "Image of the weatherapp aggregator homepage",
      },
      {
        id: 11,
        title: "Image créé par AurelDev",
        url: "Weathers_list",
        description: "Image of the result list after search",
      },
      {
        id: 12,
        title: "Image created by AurelDev",
        url: "Default",
        description: "Image of the unit converter",
      },
      {
        id: 13,
        title: "Image created by AurelDev",
        url: "Convert_meter_yards",
        description: "Image of a value converted from meter to yard",
      },
      {
        id: 14,
        title: "Image créé par AurelDev",
        url: "Convert_yards_meter",
        description: "Image of a value converted from yard to meter",
      },
      {
        id: 15,
        title: "Image created by AurelDev",
        url: "Default",
        description: "Image of the tasks timer homepage",
      },
      {
        id: 16,
        title: "Image created by AurelDev",
        url: "Add_task_menu",
        description: "Image of the adding task menu",
      },
      {
        id: 17,
        title: "Image created by AurelDev",
        url: "Edit_task_menu",
        description:
          "Image of the editing task menu when you can edit the title, the status and delete the task",
      },
      {
        id: 18,
        title: "Image created by AurelDev",
        url: "Timer_settings",
        description:
          "Image of the timer settings menu when you can edit working and breaks time and select number and type of working cycles",
      },
      {
        id: 19,
        title: "Image created by AurelDev",
        url: "Tasks_list_section",
        description: "Image of the tasks list",
      },
      {
        id: 20,
        title: "Image created by AurelDev",
        url: "Tasks_list_completed_section",
        description: "Image of the completed tasks list",
      },
      {
        id: 21,
        title: "Image created by AurelDev",
        url: "Calculator_1",
        description: "Image of calculator with calculation",
      },
    ],
  },
];
...
export const homePageContentList = reactive([
  {
    ...
    title1: "I like",
    making: "making",
    title2: "interactive, accessible and meaningful projects with",
    subtitle1: "and I",
    heart: "love",
    subtitle2: "what I do",
    quote:
  ...
  },
  {
    ...
    title1: "J'aime",
    making: "créer",
    title2: "des projets interactifs, accessibles et qui ont du sens avec du",
    subtitle1: "et J'",
    heart: "aime",
...
export const aboutList = reactive([
  {
    ...
    children2: [
      ...
      },
      {
        ...
        icon: "pen",
        children: [
          { content: "L'UX/UI est au coeur de toute création web." },
          {
            content:
